...
extern PHPAPI struct php_obj_Mustache * php_mustache_mustache_object_fetch_object(zval * zv TSRMLS_DC);


extern PHPAPI mustache::Mustache * mustache_new_Mustache(TSRMLS_D);
extern PHPAPI void mustache_data_from_zval(mustache::Data * node, zval * current TSRMLS_DC);
extern PHPAPI bool mustache_parse_data_param(zval * data, mustache::Mustache * mustache, mustache::Data ** node TSRMLS_DC);
extern PHPAPI bool mustache_parse_partials_param(zval * array, mustache::Mustache * mustache, mustache::Node::Partials * partials TSRMLS_DC);
extern PHPAPI bool mustache_parse_template_param(zval * tmpl, mustache::Mustache * mustache, mustache::Node ** node TSRMLS_DC);
